...
function downloadBIOS() {
    downloadFile("https://raw.githubusercontent.com/SyceProjects/sgs-gitcdn/main/GBA-Emulator/Binaries/gba_bios.bin", registerBIOS);
}
...
function downloadROM(gamename) {
    ...
    downloadFile("https://raw.githubusercontent.com/SyceProjects/sgs-gitcdn/main/GBA-Emulator/Binaries/" + gamename + ".gba", registerROM);
}
